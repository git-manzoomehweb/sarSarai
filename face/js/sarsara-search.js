    ...
    if ((e.closest("ul").next().val(o), n < o)) {
      ...
      for (
        ...
        e.closest(".contentRooms")
          .find(".childDropdowns")
          .append(
            '<div class="age-selection dir-rtl createChildDropdown mb-4 w-full float-right clear-both"><div class="label float-right text-sm leading-12 mb-1">سن کودک ' +
              i +
...
function addMulticityRoute(t) {
  ...
  if (
    ...
    (i.innerHTML = e),
      $(window).width() >= 1024
        ? (i.className =
            "route-content set_Date_Box relative clear-both border-b border-third border-solid pb-7 pt-5 float-right w-full")
        : (i.className =
            "route-content relative clear-both border-b border-third border-solid mb-7 mt-5 float-right w-full"),
      ...
      i.insertAdjacentHTML(
        "beforeend",
        '<div class="route-minus-btn" onclick="deleteMulticityRoute(this)">حذف <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#E52D51" class="inline-block w-5 h-5">\n  <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />\n</svg>\n</div>'
      ),
...
document.addEventListener("click", function (event) {
  document.querySelectorAll(".flightclass-box").forEach((box) => {
    const flightClassMenu = box.querySelector(".show-flightclass");

    if (!box.contains(event.target) && flightClassMenu) {
      flightClassMenu.classList.add("hidden");
    }
  });
});
document.querySelectorAll(".hotel-inputF").forEach((hotelInput) => {
  hotelInput.addEventListener("click", () => {
    document
      .querySelectorAll("ul.show-flighttype, ul.show-flightclass")
      .forEach((ul) => {
        ul.classList.add("hidden");
      });
  });
});
document.querySelectorAll(".hotel-inputH").forEach((hotelInput) => {
  hotelInput.addEventListener("click", () => {
    document
      .querySelectorAll("ul.show-flighttype, ul.show-flightclass")
      .forEach((ul) => {
...
document.querySelectorAll(".searchList").forEach((item) => {
  item.addEventListener("click", () => {
    document.querySelectorAll(".HotelPassengers").forEach((element) => {
      element.classList.add("hidden");
    });
  });
});
document.querySelectorAll(".hotel-inputH").forEach((item) => {
  item.addEventListener("click", () => {
...
document.querySelectorAll(".hotel-input").forEach((item) => {
  item.addEventListener("click", () => {
    document.querySelectorAll(".searchList").forEach((element) => {
      element.classList.add("hidden");
