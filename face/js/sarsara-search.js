...
function city_search(t) {
   ...
   })) : ($(t).closest(".city").find(".countryFlight").empty()) : $(t).val().length > 2 ? ($(t).closest(".city").find(".mini-loading").show(), $(t).closest(".city").find(".ul-list").hide(), $.ajax({
      url: "/Client_City_Search.bc",
      type: "get",
      data: {
         term: $(t).val(),
   ...
   })) : ($(t).closest(".city").find(".countryFlight").empty()) : "3" !== $(t).attr("data-type") && ($(t).val().length > 2 ? ($(t).closest(".city").find(".mini-loading").show(), $(t).closest(".city").find(".ul-list").hide(), $.ajax({
      url: "/Client_City_Search.bc",
      type: "get",
      data: {
         term: $(t).val(),
...
$("#direct").click(function () {
   $(this).addClass("active-r-btn"), $("#return").removeClass("active-r-btn"), $("#multi").removeClass("active-r-btn"), $("#multi-flight-form").addClass("hidden"), $("#flightSearch #inp2-flight").prop("disabled", !0), $("#flightSearch").find(".end_date").removeClass("nextCalOpening"), $(window).width() <= 750 && $("#flightSearch").attr("action", "/M_Oneway_Search.bc"), $("#flightSearch").show()
   $(".Flighttype-text").text("یک طرفه");
   $(".return-date-city").addClass("disabled-date");
  }); 
$(".flight-btn").click(function () {
   $(".date_info_selected").find(".type_date").text("تاریخ رفت :"), $(".date_info_selected").find(".day_of_date").text("---"), $(".date_info_selected").find(".month_of_date").text(" "), $(this).removeClass("inactive"),$(".selected").removeClass("active-module"),$(this).addClass("active-module"), $(".hotel-btn").addClass("inactive"), $(".flighthotel-btn").addClass("inactive"), $(".r-flight").show(), $(".r-hotel").hide(), $(".r-flighthotel").hide(), $("#top-banner-resize").css("background-image", 'url("../images/search-bg.jpg")')
});
$(".hotel-btn").click(function () {
   return $(".date_info_selected").find(".type_date").text("تاریخ رفت :"), $(".date_info_selected").find(".day_of_date").text("---"), $(".date_info_selected").find(".month_of_date").text(" "), $(this).removeClass("inactive"),$(".selected").removeClass("active-module"),$(this).addClass("active-module"), $(".flight-btn").addClass("inactive"),$(".flighthotel-btn").addClass("inactive"), $(".r-hotel").show(), $(".r-flight").hide(), $(".r-flighthotel").hide(), $("#top-banner-resize").css("background-image", 'url("../images/hotel-search-bg.jpg")')
});

$(".flighthotel-btn").click(function () {
   return $(".date_info_selected").find(".type_date").text("تاریخ رفت :"), $(".date_info_selected").find(".day_of_date").text("---"), $(".date_info_selected").find(".month_of_date").text(" "), $(this).removeClass("inactive"),$(".selected").removeClass("active-module"),$(this).addClass("active-module"), $(".flight-btn").addClass("inactive"), $(".hotel-btn").addClass("inactive"), $(".r-flighthotel").show(), $(".r-hotel").hide(), $(".r-flight").hide(), $("#top-banner-resize").css("background-image", 'url("../images/fh-search-bg.jpg")')
});
...
$(document).ready(function () {
   $(".close-hotel-psg").click(function () {
      ...
      $(this).attr("id"), $(this).hasClass("inactive") && ($(".selected").addClass("inactive"),$(".selected").removeClass("active-module"), $(this).removeClass("inactive"),$(this).addClass("active-module"))
   })
});
      ...
      if ($(this).closest(".city").find(".countryFlight").text().length > 0) {
         if (0 == hoverelse) {
            var t = $(this).closest(".city").find(".countryFlight").children(".selectCountry:first").find(".txtcountry").text(),
               e = (t.split(" "), $(this).closest(".city").find(".countryFlight").children(".selectCountry:first").find(".countryid").val());
...
function showMultiCity(t) {
   $("#multi-flight-form").removeClass("hidden"), $(t).addClass("active-r-btn"), $("#direct").removeClass("active-r-btn"), $("#return").removeClass("active-r-btn"), $("#flightSearch").hide(), $("#multi-flight-form").show(), $(window).width() <= 750 && $("#multi-flight-form").attr("action", "/M_MultiCity_Search.bc")
   $(".Flighttype-text").text("چند مسیره")
  }
$(window).width() >= 1024 && $("#multi-flight-form").find(".route-content").each(function () {
...
function deleteMulticityRoute(t) {
  const destination_nth_txt = ["مقصد اول", "مقصد دوم", "مقصد سوم", "مقصد چهارم"];
   ...
   let e = 0;
   document.querySelector("#multi-flight-form").querySelector(".route-container").querySelectorAll(".route-content").forEach(t => {
